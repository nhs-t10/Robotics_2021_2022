...
(function() {
  ...
  peg$SyntaxError.buildMessage = function(expected, found) {
    ...
    function describeExpectation(expectation) {
      return DESCRIBE_EXPECTATION_FNS[expectation.typeType](expectation);
    }
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c4 = function(modifiers, typeType) { return mergeProps(typeType, { modifiers: modifiers }); },
        peg$c5 = function(id, gen, ext, impl, body) {
              return {
                ...
                bodyDeclarations:    {type: "Block", statements: body},
        ...
        peg$c10 = function(typeType, id, rest) {
              return mergeProps(rest, {
                type:          'MethodDeclaration',
                returnType2:    typeType,
                name:           id,
                typeParameters: []
              });
            },
        peg$c11 = function(typeType, decls) {
              return {
        ...
        peg$c15 = function(typeType, id, rest) {
              return mergeProps(rest, {
                returnType2: typeType,
                name:        id
              });
        ...
        peg$c23 = function(typeType, id, rest) {
              if (rest.type === 'FieldDeclaration') {
                rest.fragments[0].name = id;
                return mergeProps(rest, { typeType: typeType });
              } else {
                return mergeProps(rest, { 
                  returnType2:    typeType, 
                  name:           id,
        ...
        peg$c24 = function(rest) { return { type: 'FieldDeclaration', fragments: rest }; },
        ...
        peg$c27 = function(params, typeType, id, rest) {
              return mergeProps(rest, { 
                returnType2:    typeType, 
                name:           id, 
                typeParameters: params 
        ...
        peg$c32 = function(consts, body) {
              return {
                ...
                bodyDeclarations: {type: "Block", statements: optionalList(body) }
              };
            },
        peg$c33 = function(annot, name, args, cls) {
              return {
                ...
                anonymousClassDeclaration: cls === null ? null : {
                  ...
                  bodyDeclarations:  {type: "Block", statements: cls}
                },
        ...
        peg$c36 = function(modifiers, typeType, decls) {
              return {
        ...
        peg$c39 = function(modifiers, typeType, decl) { 
        ...
        peg$c40 = function(modifiers, typeType, decl) { 
              return mergeProps(decl, {
                typeType:        typeType,
                modifiers:   modifiers,
                varargs:     true,
        ...
        peg$c56 = function(expr, cases) { return { type: 'SwitchStatement', statements: cases, expression: expr.expression }; },
        peg$c57 = function(expr, body) { return { type: 'SynchronizedStatement', expression: expr.expression, body: body } },
        peg$c58 = function(expr) { return { type: 'ReturnStatement', expression: expr } },
        peg$c59 = function(expr) { return { type: 'ThrowStatement', expression: expr }; },
        peg$c60 = function(id) { return { type: 'BreakStatement', label: id }; },
        peg$c61 = function(id) { return { type: 'ContinueStatement', label: id }; },
        peg$c62 = function() { return { type: 'EmptyStatement' }; },
        peg$c63 = function(statement) { return statement; },
        peg$c64 = function(id, statement) { return { type: 'LabeledStatement', label: id, body: statement }; },
        peg$c65 = function(modifiers, typeType, decl, expr) { 
              var fragment = mergeProps(decl, { initializer: expr });
              fragment.type = 'VariableDeclarationFragment';
              return {
        ...
        peg$c69 = function(expr, blocks) { return [{ type: 'SwitchCase', expression: expr }].concat(blocks); },
        peg$c70 = function(expr) { return expr; },
        peg$c71 = function(modifiers, typeType, decls) { 
              return [{
                type:     'VariableDeclarationExpression',
                modifiers: modifiers,
                fragments: decls,
        ...
        peg$c78 = function(operator, operand) {
              return operand.type === 'NumberLiteral' && operator === '-' && 
                (operand.token === '9223372036854775808L' || 
                 operand.token === '9223372036854775808l' ||
                 operand.token === '2147483648') 
                ? { type: 'NumberLiteral', token: text() }
                : { 
        ...
        peg$c83 = function(args, args_r) { return { type: 'ConstructorInvocation', arguments: args_r, typeArguments: [] }; },
        ...
        peg$c86 = function(suffix) { 
              return suffix.type === 'SuperConstructorInvocation' 
                ? suffix
                : mergeProps(suffix, { qualifier: null }); 
            },
        peg$c87 = function(creator) { return creator; },
        peg$c88 = function(typeType, dims) {
              return {
                type: 'TypeLiteral',
                typeType:  buildArrayTree(typeType, dims)
              };
            },
        peg$c89 = function() {
              return {
                type: 'TypeLiteral',
                typeType:  makePrimitive('void')
              };
            },
        peg$c90 = function(qual, dims) { 
              return {
                type: 'TypeLiteral',
                typeType:  buildArrayTree(buildTypeName(qual, null, []), dims)
              };
            },
        peg$c91 = function(qual, expr) { return { type: 'ArrayAccess', array: qual, index: expr }; },
        ...
        peg$c93 = function(qual) { return { type: 'TypeLiteral', typeType: buildTypeName(qual, null, []) }; },
        peg$c94 = function(qual, ret) { 
              if (ret.expression) return TODO(/* Ugly ! */);
              ret.expression = qual;
              return ret; 
            },
        peg$c95 = function(qual) { return { type: 'ThisExpression', qualifier: qual }; },
        ...
        peg$c100 = function(id, args) { return { type: 'MethodInvocation', arguments: args, name: id, typeArguments: [] }; },
        peg$c101 = function(op) { return op[0]; /* remove ending spaces */ },
        peg$c102 = function(id) { return { type: 'FieldAccess', name: id }; },
        ...
        peg$c106 = function(expr) { return { type: 'ArrayAccess', index: expr }; },
        ...
        peg$c125 = function(typeType) { return makePrimitive(typeType); },
        peg$c126 = function(args) { return optionalList(args); },
        peg$c127 = function(typeType, rest) { 
              return  { 
                type:       'ArrayCreation', 
                typeType:        buildArrayTree(typeType, rest.extraDims), 
                initializer: rest.init,
                dimensions:  rest.dimms
              }; 
            },
        peg$c128 = function(args, typeType, rest) {
              return mergeProps(rest, {
        ...
        peg$c130 = function(id, args, rest) { 
              return mergeProps(rest, {
                type: 'ClassInstanceCreation',
                typeType:  buildTypeName(id, args, [])
              });  
            },
        ...
        peg$c135 = function(init) { return { type: 'ArrayInitializer', expressions: optionalList(init) }; },
        peg$c136 = function(expr) { return { type: 'ParenthesizedExpression', expression: expr }; },
        peg$c137 = function(first, rest) { return buildQualified(first, rest, 1); },
        peg$c138 = function(exp) { return exp; },
        peg$c139 = function(typeType, dims) { return buildArrayTree(typeType, dims); },
        ...
        peg$c172 = function(typeType, rest) { return mergeProps(rest, { typeType: typeType }); },
        ...
        peg$c174 = function(fragments) { return { type: 'FieldDeclaration', fragments: fragments }; },
        ...
        peg$c178 = function(id) { return { type: 'MarkerAnnotation', typeName: id }; },
        ...
        peg$c180 = function(values) { return { type: 'ArrayInitializer', expressions: optionalList(values)}; },
        peg$c181 = /^[ \t\r\n\f]/,
        ...
        peg$c191 = function(first, rest) { return { identifier: first + rest, type: 'SimpleName' }; },
        peg$c192 = /^[a-z]/,
        ...
        peg$c268 = function() { return { type: 'BooleanLiteral', booleanValue: true }; },
        peg$c269 = function() { return { type: 'BooleanLiteral', booleanValue: false }; },
        peg$c270 = function() { return { type: 'NullLiteral' }; },
        peg$c271 = function(literal) { return literal; },
        peg$c272 = /^[lL]/,
        peg$c273 = peg$classExpectation(["l", "L"], false, false),
        peg$c274 = function() { return { type: 'NumberLiteral', token: text() }; },
        peg$c275 = "0",
        ...
        peg$c311 = function() { return { type: 'CharacterLiteral', escapedValue: text() }; },
        peg$c312 = "\"",
        peg$c313 = peg$literalExpectation("\"", false),
        peg$c314 = /^["\\\n\r]/,
        peg$c315 = peg$classExpectation(["\"", "\\", "\n", "\r"], false, false),
        peg$c316 = function() { return { type: 'StringLiteral', escapedValue: text() }; },
        peg$c317 = "\\",
    ...
    function peg$literalExpectation(text, ignoreCase) {
      return { typeType: "literal", text: text, ignoreCase: ignoreCase };
    }

    function peg$classExpectation(parts, inverted, ignoreCase) {
      return { typeType: "class", parts: parts, inverted: inverted, ignoreCase: ignoreCase };
    }
    ...
    function peg$otherExpectation(description) {
      return { typeType: "other", description: description };
    }
    ...
    function peg$parse_() {
      ...
      function popQualified(tree) {
        return tree.type === 'QualifiedName' 
