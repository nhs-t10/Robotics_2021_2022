...
public class TurnAround__macro_autoauto extends AutoautoMacro {
    ...
    public AutoautoProgram generateProgram() {
            ...
            String g="TurnAround";GotoStatement f=G(g);Statement[]$e=new Statement[]{f};State e=A($e);State[]$d=new State[]{e};String h="init";Statepath d=S($d,
h);String q="driveRaw";VariableReference p=H(q);AutoautoNumericValue s=C(1),t=C(-1),u=C(1),v=C(-1);AutoautoValue[]r={s,t,
u,v};FunctionCall o=M(p,r);FunctionCallStatement n=F(o);String y="degs";AutoautoUnitValue x=E(180,y);NextStatement z=N();AfterStatement w=W(x,
...
5,11);L(n,g,0,5,2);L(x,g,0,5,30);L(z,g,0,5,38);L(w,g,0,5,24);L(m,g,0,5,2);L(d0,g,1,6,2);L(c0,g,1,6,11);L(b0,g,1,6,2);L(a0,
g,1,5,43);return i0;
    }
}
