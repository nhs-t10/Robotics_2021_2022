...
public class IsSpecialOneFunction extends NativeRobotFunction {
    ...
    public AutoautoPrimitive call(AutoautoPrimitive[] args) {
        ...
        if(args.length == 1) {if(args[0] instanceof AutoautoNumericValue) {return new AutoautoBooleanValue(manager.isSpecial1((int)((AutoautoNumericValue)args[0]).getFloat()));}}throw new org.firstinspires.ftc.teamcode.auxilary.dsls.autoauto.runtime.errors.AutoautoNoNativeMethodOverloadException("No isSpecial1 with 1 args");
    }
}